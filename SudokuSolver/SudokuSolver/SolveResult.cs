...
namespace SudokuSolver
{
    public class SolveResult
    {
        ...
        public static SolveResult createSuccessResult(Square[,] pSolvedSudoku)
        {
            SolveResult result = new SolveResult(SUCCESS);
            result.SolveResultGrid = pSolvedSudoku;
